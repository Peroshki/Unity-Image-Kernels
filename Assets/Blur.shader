...
// Uses the Blur image kernel provided on Wikipedia. https://en.wikipedia.org/wiki/Kernel_(image_processing)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float3x3 krnl = float3x3( 1, 2, 1, 2, 4, 2, 1, 2, 1 ); // Image Kernel
